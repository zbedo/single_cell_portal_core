/**
 * React-Compound-Slider components that are not part of react-compound-slider package
 *
...
export const SliderRail = ({ getRailProps }) => {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", Object.assign({ style: railOuterStyle }, getRailProps())),
        React.createElement("div", { style: railInnerStyle })));
};
export const Handle = ({ domain: [min, max], handle: { id, value, percent }, disabled = false, getHandleProps, }) => {
    return (React.createElement(React.Fragment, null,
...
// *******************************************************
export const KeyboardHandle = ({ domain: [min, max], handle: { id, value, percent }, disabled = false, getHandleProps, }) => {
    return (React.createElement("button", Object.assign({ role: "slider", "aria-valuemin": min, "aria-valuemax": max, "aria-valuenow": value, style: {
            left: `${percent}%`,
            position: 'absolute',
