...
json.study_files do
  json.unsynced @unsynced_files, partial: 'api/v1/study_files/study_file', as: :study_file
  json.orphaned @orphaned_study_files, partial: 'api/v1/study_files/study_file', as: :study_file
  json.synced @synced_study_files, partial: 'api/v1/study_files/study_file', as: :study_file
end
