...
function main {
    ...
    run_command_in_deployment "bin/boot_docker -e $PASSENGER_APP_ENV -d $DESTINATION_BASE_DIR -h $PROD_HOSTNAME" || exit_with_error_message "Cannot start new docker container $PORTAL_CONTAINER"
    echo "### COMPLETED ###"
