...
function clean_up {
  echo "Cleaning up..."
  bundle exec bin/rails runner -e test "Study.delete_all_and_remove_workspaces" || { echo "FAILED to delete studies and workspaces" >&2; exit; } # destroy all studies/workspaces to clean up any files
