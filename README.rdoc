...
* <b>-e OAUTH_CLIENT_ID= [OAUTH_CLIENT_ID]:</b> Setting the OAUTH_CLIENT_ID variable is necessary for allowing Google user authentication.  For instructions on creating OAuth 2.0 Client IDs, refer to the {Google OAuth 2.0 documentation}[https://support.google.com/cloud/answer/6158849].
* <b>-e OAUTH_CLIENT_SECRET= [OAUTH_CLIENT_SECRET]:</b> Setting the OAUTH_CLIENT_SECRET variable is necessary for allowing Google user authentication.  For instructions on creating OAuth 2.0 Client IDs, refer to the {Google OAuth 2.0 documentation}[https://support.google.com/cloud/answer/6158849].
...
* Disabling all FireCloud access
...
Re-enabling FireCloud access will restore all permissions back to their previous state.
