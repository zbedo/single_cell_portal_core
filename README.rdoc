...
studies in the portal for QA purposes, as well as receive certain admin-related emails (see
<a href="#user-content-production-persistent-disks">PRODUCTION PERSISTENT DISKS</a> below).  This can only be enabled manually
through the console.
