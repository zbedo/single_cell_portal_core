...
#   config.attachment_file_types = ["doc", "docx", "xls", "odt", "ods", "pdf", "zip", "tar"]
#
...
#   # By default: "/assets/ckeditor/config.js.erb"
#   # config.js_config_url = "/assets/ckeditor/config.js.erb"
# end
